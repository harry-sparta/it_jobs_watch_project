...
class Top30CSVGenerator:
    ...
    def generate_top_30_csv(self, top_30_array, csv_file_location=os.path.expanduser('/home/ubuntu/Downloads/'), file_name='ItJobsWatchTop30.csv', headers_array=None):
